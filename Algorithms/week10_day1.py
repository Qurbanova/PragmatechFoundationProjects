...
# print('The result is'+ (my_function(int(3))))
# print(my_function(5))
# print(my_function(9))------> bURDA PRABLEM VAR SORUŞARSAN!
x=lambda a: a+10
print(x(5))
print(x(15))
...
def my_function(**sahe):
    print("Student's first name is" + "  "+ sahe["en"] +'  '+ "and the student id is" + "  "+ sahe["uzunluq"])
my_function(en=int(input('Düzbucaqlının eni: ')), uzunluq=int(input("Düzbucaqlının uzunluğu:  ")))
